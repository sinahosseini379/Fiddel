...
o = s:option(DummyValue, "fiddel", " ")
o.rawhtml  = true
o.template = "fiddel/node_config/link_share_man"
o.value = arg[1]
...
local types_dir = "/usr/lib/lua/luci/model/cbi/fiddel/client/type/"
s.val = {}
