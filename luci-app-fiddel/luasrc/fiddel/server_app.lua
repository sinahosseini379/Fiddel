...
local require_dir = "luci.fiddel."

local ipt_bin = sys.exec("echo -n $(/usr/share/fiddel/iptables.sh get_ipt_bin)")
local ip6t_bin = sys.exec("echo -n $(/usr/share/fiddel/iptables.sh get_ip6t_bin)")
